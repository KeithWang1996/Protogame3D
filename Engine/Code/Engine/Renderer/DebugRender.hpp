...
enum eDebugFillMode
{
	DEBUG_FILL_NORMAL,				//Solid fill without texture
	DEBUG_FILL_TEXTURE,				//Solid fill with texture
	DEBUG_FILL_WIREFRAME,			//Wireframe fill without texture
};

enum eDebugMode : unsigned int
{
	DEBUG_ALWAYS_NORMAL = 0,
	DEBUG_ALWAYS_TEXTURE,
	DEBUG_ALWAYS_WIREFRAME,
	DEBUG_DEPTH_NORMAL,
	DEBUG_DEPTH_TEXTURE,
	DEBUG_DEPTH_WIREFRAME,
	DEBUG_XRAY_NORMAL,
	DEBUG_XRAY_TEXTURE,
	DEBUG_XRAY_WIREFRAME,
	DEBUG_MODE_NUM
};
/************************************************************************/
/*                                                                      */
...
// line strip [extra]
void DebugAddWorldLineStrip(unsigned int count, Vec3 const* positions,
...
// Quads
void DebugAddWorldQuad(Vec3 p0, Vec3 p1, Vec3 p2, Vec3 p4, Rgba8 start_color, Rgba8 end_color, float duration, eDebugRenderMode mode = DEBUG_RENDER_USE_DEPTH);

// bounds
void DebugAddWorldWireBounds(AABB3 bounds, Mat44 TransformMat, Rgba8 start_color, Rgba8 end_color, float duration, eDebugRenderMode mode = DEBUG_RENDER_USE_DEPTH);
void DebugAddWorldWireBounds(AABB3 bounds, Mat44 TransformMat, Rgba8 color, float duration = 0.0f, eDebugRenderMode mode = DEBUG_RENDER_USE_DEPTH);
